...
function MainMenu() {
const styles={btn:" border-white border-2 text-white flex justify-center items-center flex-col gap-3 lg:w-125 md:w-110 sm:w-99 hover:bg-gray-100 hover:text-black transition delay-5 ease-in-out active:translate-x-2 active:translate-y-2",
...
<>
    <div className='min-h-screen bg-black text-white font-mono flex flex-col items-center justify-center p-4 selection:bg-white selection:text-black'>
            ...
            <h1 className='text-white text-6xl font-extrabold font-[archivo-black-regular]' >flwo</h1>
